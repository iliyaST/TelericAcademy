...
class SubstractingPolynomials
{
    ...
    static void SubstractionOfPolynomials(List<int> firstArray, List<int> secondArray, List<int> sumList)
    {
        for (int i = 0; i < firstArray.Count; i++)
        {
            sumList.Add(firstArray[i] - secondArray[i]);
    ...
    static void MultiplicationOfPolynomials(List<int> firstArray, List<int> secondArray, List<int> sumList)
    {
        for (int i = 0; i < firstArray.Count; i++)
        {
            sumList.Add(firstArray[i] * secondArray[i]);
    ...
    static void Main()
    {
        ...
        //substracting
        SubstractionOfPolynomials(firstArray, secondArray, sumList);
        ...
        sumList.Clear();
        //multiplication
        MultiplicationOfPolynomials(firstArray, secondArray, sumList);
