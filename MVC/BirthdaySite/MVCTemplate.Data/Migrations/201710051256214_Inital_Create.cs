    ...
    public partial class Inital_Create : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        ...
                        FriendListId = c.Int(nullable: false),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.FriendsLists", t => t.FriendListId, cascadeDelete: true)
                .Index(t => t.FriendListId)
                .Index(t => t.IsDeleted);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Friends", "FriendListId", "dbo.FriendsLists");
            ...
            DropIndex("dbo.FriendsLists", new[] { "IsDeleted" });
            DropIndex("dbo.Friends", new[] { "IsDeleted" });
            DropIndex("dbo.Friends", new[] { "FriendListId" });
